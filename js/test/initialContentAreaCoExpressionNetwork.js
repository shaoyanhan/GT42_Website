...
import { getData, updateData, fetchHubNetworkGraphJSON, fetchSingleNetworkGraphJSON, fetchRawData, validateGenomeID } from "./data.js";
...
async function initialHubCoExpressionNetwork(networkResolution = 'mosaic') {
    ...
    // toggleButtonsDisabled(hub_network_selector_container, true); // 禁用所有按钮
