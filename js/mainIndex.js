...
export let annotationTypeCountDOM = document.getElementById('annotation_type_count');
export let dockingConfidenceCountDOM = document.getElementById('docking_confidence_count');
...
export let annotationTypeCountChart = echarts.init(annotationTypeCountDOM, null, { renderer: 'canvas' });
export let dockingConfidenceCountChart = echarts.init(dockingConfidenceCountDOM, null, { renderer: 'canvas' });
